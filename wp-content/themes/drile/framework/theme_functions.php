...
function drile_register_required_plugins(){
    ...
    $plugins = array(
		...
		,array(
			...
			,'source'             => 'https://downloads.wordpress.org/plugin/redux-framework.4.1.26.zip'
            ,'required'           => true
			,'version'            => '4.1.26'
            ,'external_url'       => ''
        )
		,array(
            'name'                => 'WooCommerce'
            ,'slug'               => 'woocommerce'
			,'source'             => 'https://downloads.wordpress.org/plugin/woocommerce.5.3.0.zip'
            ,'required'           => true
			,'version'            => '5.3.0'
            ,'external_url'       => ''
        )
		...
		,array(
			...
			,'source'             => 'https://downloads.wordpress.org/plugin/mailchimp-for-wp.4.8.4.zip'
            ,'required'           => false
			,'version'            => '4.8.4'
            ,'external_url'       => ''
        )
		,array(
			...
			,'source'             => 'https://downloads.wordpress.org/plugin/yith-woocommerce-wishlist.3.0.22.zip'
            ,'required'           => false
			,'version'            => '3.0.22'
            ,'external_url'       => ''
        )
		,array(
			...
			,'source'             => 'https://downloads.wordpress.org/plugin/yith-woocommerce-compare.2.5.1.zip'
            ,'required'           => false
			,'version'            => '2.5.1'
            ,'external_url'       => ''
        )
